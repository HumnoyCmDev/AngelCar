package com.beta.cls.angelcar.manager.http;
 ...
 * HttpChatManager.java // HttpManager.java --> สำหรับ Convert Gson To Pojo Object
 */
public class OkHttpManager {
    ...
    public static class SendMessageBuilder {
        private String url = "http://angelcar.com/ga_chatcar.php?operation=new&message=";
        private Request request;
...
//        private String urlUploadImage = "http://angelcar.com/gachatcarimageupload.php";
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        if (responseFile.isSuccessful()){ // upload success
                            Log.i(TAG, "onResponse: up load image success : "+ responseFile.body().string());
                            // Send message
                                Request.Builder builder = new Request.Builder();
                                Request requestMsg = builder.url(String.format(urlMessage,responseFile.body().string())).build();
