 ...
 */
public class ViewMessageByAdminModel {

    private List<MessageviewbyadminarayEntity> messageviewbyadminaray;

    public void setMessageviewbyadminaray(List<MessageviewbyadminarayEntity> messageviewbyadminaray) {
        this.messageviewbyadminaray = messageviewbyadminaray;
    }

    public List<MessageviewbyadminarayEntity> getMessageviewbyadminaray() {
        return messageviewbyadminaray;
    }

    public static class MessageviewbyadminarayEntity {
